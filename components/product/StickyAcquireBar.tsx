      ...
      <div className="flex items-center gap-3">
        {canAcquire ? (
          <Link
            ...
            data-cta-id="pdp_acquire"
            data-cta-label="Acquire"
          >
            Acquire
          </Link>
        ) : (
          <Link
            href="/concierge"
            className="tap-scale inline-block border border-[rgba(201,162,39,0.5)] bg-transparent px-5 py-2.5 text-xs font-medium uppercase tracking-widest text-[#f5f0e8]"
            data-cta-id="pdp_request_availability"
            data-cta-label="Request availability"
          >
        ...
        <Link
          ...
          data-cta-id="pdp_speak_artisan"
          data-cta-label="Speak with an artisan"
        >
